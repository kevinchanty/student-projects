...
max_step = 300
step_delay = 500
game_server = 'localhost:8081'

# Names, Path
save_name  ='v7_vision_updated'
...
env = gym.make('agar-v7')

env.config(screen_size= [500,500], screen_split = [3,3], url="http://localhost:3000", max_step=max_step, step_delay=step_delay,server=game_server,vision_distance=2000,verbose_n=100)
