...
class Player {
    ...
    updateView(len) {
        // len: (0: game not started, 1: game started)
        // centerPos: center of the window relative to the whole environment, in Vec2 {x and y coordinate}
        // getLivingScale: the scale of the view point range between 1 and 0 and 1 is the max zoom
        // view Box is a Quad Object that contains minx, miny, maxx and maxy
