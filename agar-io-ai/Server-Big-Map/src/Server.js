...
class Server {
    ...
    start() {
        this.timerLoopBind = this.timerLoop.bind(this); // used to extract the timer loop
        this.mainLoopBind = this.mainLoop.bind(this); // used to extract the main loop
        // Set up gamemode(s)
        ...
        this.httpServer.listen(this.serverPort, this.config.serverBind, this.onHttpServerOpen.bind(this));
    ...
    onHttpServerOpen() {
        ...
        // Done
        Logger.info("Game server started, on port " + this.serverPort);
    ...
    onServerSocketError(error) {
        ...
        switch (error.code) {
            case "EADDRINUSE":
                Logger.error("Server could not bind to port " + this.serverPort + "!");
    ...
    spawnFood() {
        ...
        cell.color = this.getRandomColor() // setting the colour of food
        this.addNode(cell);
    }
    spawnVirus() {
