...
def screenshot(page):
    ...
    image_rgb = image_rgb.resize((150, 150))  # resize the screenshot
    image_rgb = image_rgb.convert('L')  # convert the screenshot to greyscale
    # image_rgb.save("AI-debug.jpeg")
...
class agarv0(Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(
            low=0, high=255, shape=(150, 150), dtype=np.uint8
        )
